<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tomato.aspx.cs" Inherits="tomato" %>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div id="wowslider-container1" style="width: 1000px; height: 270px">
                <div class="ws_images" style="width: 1000px; height: 270px">
                    <a href="#">
                        <img src="imgs/t2.jpg" alt="" title="Mexican green tomatoes or jamberries are called tomatillos, it does not belong to tomato plant" id="wows0" style="width: 1000px; height: 270px;" /></a>

                    <a href="#">
                        <img  src="imgs/t11.jpg" alt="" title="Green tomatoes will ripe if you store them together with apples. Released ethylene gas will provide perfect conditions to ripen faster" id="wows1" style="width: 1000px; height: 270px;" /></a>
                    <a href="#">
                        <img src="imgs/t3.jpg" alt="" title="Tomatoes come in many different types of fruit—fresh or beefsteak types, grape, saladette, cherry, plum or paste, and others " id="wows2" style="width: 1000px; height: 270px;" /></a>
                </div>
